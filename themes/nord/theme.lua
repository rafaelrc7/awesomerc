...
theme.fixed_outside_gap_amount = 0
...
if file_exists(os.getenv("HOME") .. "/Pictures/wallpaper/default") then
    theme.wallpaper = os.getenv("HOME") .. "/Pictures/wallpaper/default"
else
    theme.wallpaper = themes_path.."default/wallpapers/spitfire.png"
end
